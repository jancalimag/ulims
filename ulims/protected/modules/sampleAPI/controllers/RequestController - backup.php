...
class RequestController extends Controller
{
	...
	public function actionPrint($id)
	{
        ...
        //$pdf->SetHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, $request->requestRefNum, "selling report for Jun- 2013");
        //$pdf->setHeaderFont(Array(PDF_FONT_NAME_MAIN, '', PDF_FONT_SIZE_MAIN));
        //$pdf->setFooterFont(Array(PDF_FONT_NAME_DATA, '', PDF_FONT_SIZE_DATA));
        $pdf->SetMargins(0, 287.15, 50);
        ...
        $pdf->AddPage();
            	...
            	foreach($request->samps as $sample){
            		$html .='
	            		<tr>
	            			...
	            			<td width="45">'.$sample->sampleCode.'</td>';
	            			$sampleCount = 1;
            				foreach($sample->analyses as $analysis){
            					if($sampleCount > 1){
            						$html .='
            					...
            					$html .= '
				            			...
				            			<td width="52">1</td>
				            			<td width="52">'.$analysis->fee.'</td>
				            			<td width="52">'.$analysis->fee.'</td></tr>
	            					';
            					
            					//$html .='<td width="52">7</td>';
            					//$html .='</tr>';	
            					$sampleCount += 1;
            				}
            ...
            $pdf->writeHTMLCell(200,'',4,87,$class1.$html, 0, 2);

...
echo CHtml::link('<span class="icon-white icon-print"></span> Print PDF', $this->createUrl('request/print', array('id'=>$model->id)), array('class'=>'btn btn-success', 'target'=>'_blank'));
?>
</div>

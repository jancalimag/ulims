...
/**
 * This is the model class for table "sample2".
 *
 * The followings are the available columns in table 'sample2':
 * @property integer $id
 ...
 */
class Sample2 extends CActiveRecord
{
	/**
	 ...
	 * @return Sample2 the static model class
	 */

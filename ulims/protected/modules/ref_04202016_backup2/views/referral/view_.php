...
?>
<?php 
//echo Referral::owner($referral["receivingAgencyId"]);
//echo "<br/>";
//echo Referral::recipient($referral["acceptingAgencyId"]);

//print_r($samples);
//print_r($modelStatus);
//$modelStatus->referral_id;
//print_r($acceptingAgencyLookup);
//print_r($referral);
?>
...
<?php }else{ ?>
	...
	//$this->widget('bootstrap-editable.EditableDetailView', array(
	/*$this->widget('bootstrap.components.bootstrap-editable.EditableDetailView', array(
    'id' => 'user-details',
    'data' => $modelStatus,
    ...
    'attributes'=>array(
        array(
        	...
        	//'template'=>"<tr class=\"{class}\"><th>{label}</th><td id={$modelStatus->acceptingAgencyId} class='editable' data-attribute='name'>{value}</td></tr>\n",
        ),
        array(               
            'name'=>'sampleArrivalDate',
        ),

...
$this->widget('zii.widgets.jui.CJuiTabs',array(
    'tabs'=>array(
        ...
        'ReferralIn &nbsp;&nbsp;<span class="badge badge-warning">'.$newReferrals.'</span>'=>array('content'=>$this->renderPartial(
                                        '_referralIn', 
                                        array('referralIn'=>$referralIn)
                                        ), 'id'=>'referral-in',),
		/**'ReferralOut'=>array('id'=>'referral-out','content'=>$this->renderPartial(
                                        '_referralOut',
                                        array('referralOut'=>$referralOut),false, true
                                        )),*/
    ),

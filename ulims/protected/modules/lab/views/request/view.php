...
<?php $form = $this->beginWidget('CActiveForm', 
                                             [
                                                 ...
                                                 //'focus'                    =>  [ $model,'reportDue'],
                                             ]
        );  ?>
    
    <div class="row">
        <h4 class="paddingLeftRight10">Report Due</h4>
		<?php
            $this->widget('zii.widgets.jui.CJuiDatePicker',
                          [
                              'name'        => 'Request_reportDue',
                              'id'          => 'Request_reportDue',
                              'model'       => $model,
        ...
        <?php echo CHtml::ajaxButton(
                'Save',
                $this->createUrl('request/saveReportDue'),
                [
                    'type'  => 'POST',
                    'data'  => 'js: { "requestId": "'. $model->id .'", "reportDue": $("#Request_reportDue").val()  }',
                    'error' => 'js: function (xhr, ajaxOptions, thrownError) { alert(thrownError); }',
                    'success' => 'js: function (response) { alert(response); }'
                ],
                [
                    'class' => 'btn btn-info btn-snall',
                    'id' => 'saveReportDue'
                ]
        ); ?>

...
/**
 * This is the model class for table "request2".
 *
 * The followings are the available columns in table 'request2':
 * @property integer $id
 ...
 */
class Request2 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('requestRefNum, requestId, requestDate, reportDue, requestTime, rstl_id, labId, customerId, paymentType, discount, orId, total, reportDue, conforme, receivedBy, cancelled, create_time', 'required'),
	 ...
	 * @return Request2 the static model class
	 */
